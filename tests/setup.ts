...
const TESTING_ENV_BASE = {
  ...
  | 'CACHE_PENDING_WAIT_TIMEOUT_MS'
  | 'ENABLE_DIRECT_DOWNLOADS'
  | 'BENCHMARK'
  | 'SKIP_TOKEN_VALIDATION'
  | 'STORAGE_FILESYSTEM_CACHE_MAX_SIZE_BYTES'
  | 'STORAGE_FILESYSTEM_CACHE_MAX_OBJECT_SIZE_BYTES'
  | 'DOCKERHUB_MIRROR_ENABLED'
  | 'DOCKERHUB_REGISTRY_URL'
  | 'DOCKERHUB_AUTH_URL'
  | 'DOCKERHUB_MANIFEST_TTL_SECONDS'
  | 'DOCKERHUB_PENDING_WAIT_TIMEOUT_MS'
> &
